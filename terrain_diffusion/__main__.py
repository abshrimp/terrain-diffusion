...
from terrain_diffusion.data.preprocessing.build_tiles_dataset import build_tiles_dataset as build_tiles_dataset_main
...
cli.add_command(build_tiles_dataset_main, name='build-tiles-dataset')
